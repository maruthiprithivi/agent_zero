...
from agent_zero import create_clickhouse_client, list_databases, list_tables, run_select_query
...
class TestMonitoringTools(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_processes_result = create_mock_result(
            ...
            result_rows=[
                ["123", "default", "SELECT 1"],
                ["456", "default", "SELECT 2"]
            ]
        )
        ...
        self.mock_duration_result = create_mock_result(
            ...
            result_rows=[
                ["2024-03-01 00:00:00", 100, 0.1, 0.5]
            ]
        )
        ...
        self.mock_sizing_result = create_mock_result(
            column_names=["hostname", "cpu_cores", "memory"],
            result_rows=[
                ["host1", 8, "64 GB"]
            ]
        )
